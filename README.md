...
> [!TIP]
> On a Council host, `wan render` queues the job for the WAN worker and publishes a Nexus-compatible job record when Nexus is reachable. Piper receives the queued-spec materialization request through Nexus.
